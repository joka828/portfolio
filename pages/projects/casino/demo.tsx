  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Joaquin Candalaft's casino project demo"
        />
      </Head>
      ...
      <main className={styles.main}>
        ...
        <span className={styles.disclaimer}>
          Disclaimer: Mazmo has sexually explicit content. To see the app live
          while avoiding any sexual content, follow the below steps.
        </span>
        <span className={styles.liveDemoInfo}>
          ...
          <a
            className={styles.link}
            href="https://mazmo.net/chat/channels/6070e6365095e800113db8ba"
            target="_blank"
            rel="noreferrer"
          >
            clicking here
